  ...
  const lombaList: Lomba[] = [
    {
      ...
      rules: [
        "Biaya Early bird samapai 30 September, setelahnya akan di kenakan biaya normal",
        "Memberikan uang deposit sebesar Rp.50.000/tim saat registrasi ulang",
        "Informasi lebih lanjut, klik buku syarat",
      ],
    ...
    },
    {
      ...
      category: "Kebahasaan, Seni, & Public Speaking",
      icon: faMicrophone,
    ...
    },
    {
      ...
      icon: faCalculator,
      image: "/content/Lomba OSN MTK.png",
      target: "SMP/MTs/Sederajat",
      prize: "Piagam, Medali, Uang Tunai, Beasiswa",
      fee: "Gratis/Peserta",
      date: "15 November 2026",
      description:
      ...
      contactPerson: "via Form",
      registrationUrl: "https://forms.gle/2cNpkirviAxKGtat8",
      driveUrl: "https://drive.google.com/file/d/1UE-FAepgqAox4C80qIKOOPY9spcBN9mJ/view?usp=sharing",
    },
    {
      id: "mhq",
      title: "MHQ",
    ...
    },
    {
      ...
      date: "14 November 2026",
      description:
        "Ajang menguji ke-kreatifan setiap kelompok, dan di lukis di sebuah tempat yang baik",
      rules: [
        "Tema mural: 'Hutan & Alam yang indah'",
        "Durasi 1 jam 30 menit per tim",
        "Penilaian meliputi: Kreatif, Lukisan, Detail, & Kekompakan",
    ...
    },
    {
      ...
      rules: [
        ...
        "Penilaian meliputi: Artikulasi, Mimik, Penghayatan, & Kesesuaian teks",
